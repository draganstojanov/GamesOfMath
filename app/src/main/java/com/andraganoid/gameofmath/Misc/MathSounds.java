...
public class MathSounds {
  ...
  //  private int soundsToLoad;
    ...
    private static MathSounds mathSounds = null;
...
//    }
    ...
    public static MathSounds getInstance(Context context) {

        if (mathSounds == null) {
            mathSounds = new MathSounds(context);
        }
        return mathSounds;
    }


    private MathSounds(Context context) {
